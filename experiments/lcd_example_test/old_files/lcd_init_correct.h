...
#define CPU_PWR_PIN     GPIO_PIN_6   // PC6 - CON_POW_CPU (主电源)
...
// 背光控制宏（注意逻辑变化！）
// PB1: HIGH=高亮, LOW=低亮
// PB2: LOW=开机, HIGH=关机（高阻态）
#define LCD_BL1_High()  HAL_GPIO_WritePin(LCD_BL1_PORT, LCD_BL1_PIN, GPIO_PIN_SET)    // 高亮
#define LCD_BL1_Low()   HAL_GPIO_WritePin(LCD_BL1_PORT, LCD_BL1_PIN, GPIO_PIN_RESET)  // 低亮

#define LCD_BL2_On()    HAL_GPIO_WritePin(LCD_BL2_PORT, LCD_BL2_PIN, GPIO_PIN_RESET)  // 开机
#define LCD_BL2_Off()   HAL_GPIO_WritePin(LCD_BL2_PORT, LCD_BL2_PIN, GPIO_PIN_SET)    // 关机
