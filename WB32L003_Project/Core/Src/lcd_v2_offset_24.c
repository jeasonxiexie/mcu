/**
 * @file lcd_v2_offset_24.c
 * @brief LCD driver variant 2 - 24 pixel X-axis offset (BOE recommended)
 * @version v2
 */
...
{
    /* V2: 24 pixel X-axis offset (BOE recommended) */
    LCD_WriteCommand(0x2A);
    LCD_WriteData8(0x00);
    LCD_WriteData8(x1 + 24);  /* 24 pixel offset */
    LCD_WriteData8(0x00);
    LCD_WriteData8(x2 + 24);  /* 24 pixel offset */
