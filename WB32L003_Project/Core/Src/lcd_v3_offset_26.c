/**
 * @file lcd_v3_offset_26.c
 * @brief LCD driver variant 3 - 26 pixel X-axis offset
 * @version v3
 */
...
{
    /* V3: 26 pixel X-axis offset */
    LCD_WriteCommand(0x2A);
    LCD_WriteData8(0x00);
    LCD_WriteData8(x1 + 26);  /* 26 pixel offset */
    LCD_WriteData8(0x00);
    LCD_WriteData8(x2 + 26);  /* 26 pixel offset */
