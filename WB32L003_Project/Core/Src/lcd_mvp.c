 ...
 * @version 1.0
 * Based on 京东方 0.96IPS ST7735S demo code
 */
...
void LCD_GPIO_Init(void)
{
    ...
    /* Enable GPIO clocks - LCD on GPIOC, Backlight on GPIOB */
    __HAL_RCC_GPIOB_CLK_ENABLE();
    __HAL_RCC_GPIOC_CLK_ENABLE();
    
    /* Configure LCD control pins on GPIOC */
    ...
    /* Configure backlight pins on GPIOB */
...
{
    /* Note: 京东方 demo has 24 pixel X-axis offset */
