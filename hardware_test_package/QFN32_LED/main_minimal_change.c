/* MINIMAL CHANGE VERSION - Only change PC4 to PC0 */
/* Everything else EXACTLY as TIM10_Count */
...
int main(void)
{
  ...
  /* THE ONLY CHANGE: PC4 -> PC0 */
  RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOC, ENABLE);
  GPIO_Init(GPIOC, GPIO_Pin_0, GPIO_MODE_OUT | GPIO_PUPD_NOPULL | GPIO_OTYPE_PP | GPIO_SPEED_HIGH);  /* Changed from GPIO_Pin_4 to GPIO_Pin_0 */
  
  /* PD4 as TIM10 EXT Single - KEEP EXACTLY AS ORIGINAL */
...
/* 
 * TIM1_CH1 PC6 - KEEP EXACTLY AS ORIGINAL
 */
void Tim1_Config(void)
{
...
void TIM10_IRQHandler(void)
{
  if(BaseTim_GetFlagStatus(TIM10) != RESET)
  {
    ...
    GPIO_ToggleBits(GPIOC, GPIO_Pin_0);  /* THE ONLY CHANGE: GPIO_Pin_4 -> GPIO_Pin_0 */
  }
}
