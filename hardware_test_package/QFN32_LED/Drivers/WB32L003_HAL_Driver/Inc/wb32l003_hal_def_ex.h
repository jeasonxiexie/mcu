#ifndef __WB32L003_HAL_DEF_EX_H
#define __WB32L003_HAL_DEF_EX_H
...
#define IS_GPIO_PIN_ACTION(ACTION) (((ACTION) == GPIO_BIT_RESET) || \
                                   ((ACTION) == GPIO_BIT_SET))
...
/* NVIC functions that are missing - commented out as they're defined in core_cm0plus.h */
#if 0
...
#define SET            ((FlagStatus)1U)
#define RESET          ((FlagStatus)0U)
...
/* Missing RCC register bit definitions */
...
/* RCC_CFGR2_PREDIV is already defined above (line 391-393) */

/* Flash register definitions - FLASH_ACR_LATENCY is already defined above (line 326-328) */

/* GPIO register definitions - GPIO_MODER_MODE0_Pos is already defined above as GPIO_MODER_MODER0_Pos (line 26) */
#define GPIO_MODER_MODE0_Pos             GPIO_MODER_MODER0_Pos

/* Other HAL macros - __HAL_RCC_GET_SYSCLK_SOURCE is already defined above (line 337) */
...
#define PWR_CR_LPSDSR_Pos        (0U)  /* Same as LPDS for low power regulator */
...
/* __HAL_RCC_GET_FLAG is already defined above (line 339-341) */

#endif  /* WB32L003_HAL_DEF_EX_H */