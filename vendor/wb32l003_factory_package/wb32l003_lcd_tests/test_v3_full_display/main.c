 ...
 * LCD: 0.96" TFT, 80x160 pixels, ST7735S driver
 */
...
void lcd_set_window(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1) {
    /* Add X offset for 0.96" display */
    uint8_t x_offset = 24;  /* Common offset for 80x160 displays */
...
int main(void) {
    ...
    GPIOC_ODR = (1 << LCD_CS_PIN) |     /* CS HIGH */
